	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 col-md-offset-1 text-center">
				<h1 style="font-size: 20pt; color:black;"><b><?php echo $pengabdian->nama_agenda; ?></b></h1>
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 text-center">
				...
				<div class="blog-post">
					...
					<center><img width="900" src="<?php echo base_url(); ?>uploads/<?php echo $pengabdian->avatar; ?>" />

						<br />
						<br />
						<br />
						<p class="white-text" style="text-align:justify; color:black;"><?php echo $pengabdian->deskripsi_agenda; ?></p>
					...
					<table width="100%">
						...
						<td style="text-align: center;">
							...
							$tanggal_pelaksanaan = $pengabdian->tanggal_pelaksanaan;
						...
						<td style="text-align: center;">
							<p style="text-align: center; color:black;"><?php echo $pengabdian->tempat; ?></p>
						</td>

						<td style="text-align: center;">
							<p style="text-align: center; color:black;"><?php echo $pengabdian->peserta; ?></p>
						</td>
						...
						<td style="text-align: center;">
							...
							// Tanggal yang akan diubah formatnya
							$bts_pendaftaran = $pengabdian->batas_waktu_pendaftaran;
						...
						<td style="text-align: center;">
							<p style="text-align: center; color:black;"><?php echo $pengabdian->kuota . " " . "orang"; ?></p>
						</td>
					</table>
					<br />
					<br />
					...
					<?php if ($this->session->userdata('role') === 'PPKG') { ?>
						<button class="main-button icon-button">
							<a style="color: white;" href="<?php echo site_url('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/create_peserta/' . $pengabdian->id_pengabdian); ?>">Registrasi Sekarang</a>
						</button>
						<br />
						<br />
						...
						if ($pengabdian->peserta == 'Umum') { ?>
							<button class="main-button icon-button">
								<a style="color: white;" href="<?php echo site_url('non_ppkg/pengabdian_non_ppkg/c_pengabdian_non_ppkg/create_peserta/' . $pengabdian->id_pengabdian); ?>">Registrasi Sekarang</a>
							</button>
						<?php } ?>
						<br />
						<br />
					...
					<?php
						...
						<button class="main-button icon-button">
							<a style="color: white;" href="<?php echo site_url('admin/pengabdian_admin/c_pengabdian_admin/daftar_semua_peserta/' . $pengabdian->id_pengabdian); ?>">Cek Daftar Peserta</a>
						</button>
						<br />
						<br />
						<button style="background-color: black;">
