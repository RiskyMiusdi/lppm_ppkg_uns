		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="contact-form">
					...
					<form method="post" action="<?php echo site_url('c_login/proses_untuk_melihat_artikel_pengabdian/' . $event->id_artikel_pengabdian); ?>">

						<div class="form-group">

							<input type="hidden" class="form-input" name="id_pengabdian" id="id_pengabdian" value="<?php echo $event->id_artikel_pengabdian; ?>">
						</div>
						<div class="form-group">
							<h4>Username</h4>
