	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 col-md-offset-1 text-center">
				<h1 style="font-size: 20pt; color:black;"><b><?php echo $kerjasama->nama_agenda; ?></b></h1>
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 text-center">
				...
				<div class="blog-post">
					...
					<center><img width="900" src="<?php echo base_url(); ?>uploads/<?php echo $kerjasama->avatar; ?>" />

						<br />
						<br />
						<br />
						<p class="white-text" style="text-align:justify; color:black;"><?php echo $kerjasama->deskripsi_agenda; ?></p>
					...
					<table width="100%">
						...
						<td style="text-align: center;">
							...
							$tanggal_pelaksanaan = $kerjasama->tanggal_pelaksanaan;
						...
						<td style="text-align: center;">
							<p style="text-align: center; color:black;"><?php echo $kerjasama->tempat; ?></p>
						</td>


						<td style="text-align: center;">
							<p style="text-align: center; color:black;"><?php echo $kerjasama->peserta; ?></p>
						</td>
						...
						<td style="text-align: center;">
							...
							// Tanggal yang akan diubah formatnya
							$bts_pendaftaran = $kerjasama->batas_waktu_pendaftaran;
						...
						<td style="text-align: center;">
							<p style="text-align: center; color:black;"><?php echo $kerjasama->kuota . " " . "orang"; ?></p>
						</td>
					</table>
					<br />
					<br />
					...
					<?php if ($this->session->userdata('role') === 'PPKG') { ?>
						<button class="main-button icon-button">
							<a style="color: white;" href="<?php echo site_url('ppkg/kerjasama_ppkg/c_kerjasama_ppkg/create_peserta/' . $kerjasama->id_kerjasama); ?>">Registrasi Sekarang</a>
						</button>
						<br />
						<br />
						...
						if ($kerjasama->peserta == 'Umum') { ?>
							<button class="main-button icon-button">
								<a style="color: white;" href="<?php echo site_url('non_ppkg/kerjasama_non_ppkg/c_kerjasama_non_ppkg/create_peserta/' . $kerjasama->id_kerjasama); ?>">Registrasi Sekarang</a>
							</button>
						<?php } ?>
						<br />
						<br />
					...
					<?php
						...
						<button class="main-button icon-button">
							<a style="color: white;" href="<?php echo site_url('admin/kerjasama_admin/c_kerjasama_admin/daftar_semua_peserta/' . $kerjasama->id_kerjasama); ?>">Cek Daftar Peserta</a>
						</button>
						<br />
						<br />
						<button style="background-color: black;">
