...
<head>
    ...
    <link rel="icon" href="<?php echo base_url() ?>assets/img/Logo-non_PPKG-LPPM-UNS-Text-Putih.png" type=" image/ico">
</head>
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="<?php echo base_url(); ?>index.php/c_home" class="site_title"><img src="<?php echo base_url() ?>assets/img/Logo-PPKG-LPPM-UNS-Text-Putih.png" width="200" alt="logo non_PPKG UNS"></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="<?php echo base_url() ?>index.php/non_ppkg/c_dashboard_non_ppkg"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                                <li><a href="<?php echo base_url() ?>index.php/non_ppkg/c_profil_non_ppkg"><i class="fa fa-user"></i> Profil</a></li>

                                <li><a><i class="fa fa-graduation-cap"></i>Pendidikan<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?php echo base_url(); ?>index.php/non_ppkg/pendidikan_non_ppkg/c_pendidikan_non_ppkg/daftar_semua_event">Event</a></li>
                                        <li><a href=" <?php echo base_url(); ?>index.php/non_ppkg/pendidikan_non_ppkg/c_pendidikan_non_ppkg/daftar_semua_artikel">Artikel</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-share-alt"></i>Pengabdian<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?php echo base_url(); ?>index.php/non_ppkg/pengabdian_non_ppkg/c_pengabdian_non_ppkg/daftar_semua_event">Event</a></li>
                                        <li><a href=" <?php echo base_url(); ?>index.php/non_ppkg/pengabdian_non_ppkg/c_pengabdian_non_ppkg/daftar_semua_artikel">Artikel</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-search"></i>Penelitian<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?php echo base_url(); ?>index.php/non_ppkg/penelitian_non_ppkg/C_penelitian_non_ppkg/daftar_semua_event">Event</a></li>
                                        <li><a href=" <?php echo base_url(); ?>index.php/non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/daftar_semua_artikel">Artikel</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-microphone"></i>Seminar<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?php echo base_url(); ?>index.php/non_ppkg/seminar_non_ppkg/C_seminar_non_ppkg/daftar_semua_event">Event</a></li>
                                        <li><a href=" <?php echo base_url(); ?>index.php/non_ppkg/seminar_non_ppkg/c_seminar_non_ppkg/daftar_semua_artikel">Artikel</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-gears"></i>Kerja Sama<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?php echo base_url(); ?>index.php/non_ppkg/kerjasama_non_ppkg/C_kerjasama_non_ppkg/daftar_semua_event">Event</a></li>
                                        <li><a href=" <?php echo base_url(); ?>index.php/non_ppkg/kerjasama_non_ppkg/C_kerjasama_non_ppkg/daftar_semua_artikel">Artikel</a></li>
                                    </ul>
                                </li>
