				...
				<div class="x_panel" style="border:2px solid black; color:black;">
					...
					<div class="x_content">
						<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
							...
							<br />
							<br />
							<a href="<?php echo base_url(); ?>index.php/non_ppkg/c_profil_non_ppkg/edit/<?php echo $user['id_user']; ?>" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
