                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo site_url('non_ppkg/pengabdian_non_ppkg/c_pengabdian_non_ppkg/update_event_pengabdian/' . $pengabdian->id_pengabdian); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">

                                    <br />
                                    <center>
                                        <span class="section">Formulir Edit <?php echo $pengabdian->nama_agenda; ?></span>
                                    </center>
                                    <br />
                                    <br />
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea id="nama_agenda" class="form-control col-md-7 col-xs-12" name="nama_agenda" type="text"><?php echo $pengabdian->nama_agenda; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="<?php echo $pengabdian->tempat; ?>" id="tempat" class="form-control col-md-7 col-xs-12" name="tempat" type="text">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="peserta" class="form-control col-md-7 col-xs-12" name="peserta" required="required">
                                                <option value="<?php echo $pengabdian->peserta; ?>"><?php echo $pengabdian->peserta; ?></option>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="<?php echo $pengabdian->kuota; ?>" id="kuota" class="form-control col-md-7 col-xs-12" name="kuota" type="number">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="<?php echo $pengabdian->tanggal_pelaksanaan; ?>" id="tanggal_pelaksanaan" class="form-control col-md-7 col-xs-12" name="tanggal_pelaksanaan" type="date">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea type="text" id="deskripsi_agenda" name="deskripsi_agenda" class="form-control col-md-7 col-xs-12"><?php echo $pengabdian->deskripsi_agenda; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="<?php echo $pengabdian->batas_waktu_pendaftaran; ?>" type="date" id="batas_waktu_pendaftaran" name="batas_waktu_pendaftaran" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/non_ppkg/pengabdian_non_ppkg/c_pengabdian_non_ppkg/daftar_semua_event">Batal</a>
