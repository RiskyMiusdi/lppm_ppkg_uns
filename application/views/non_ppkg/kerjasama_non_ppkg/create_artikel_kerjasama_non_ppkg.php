    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                ...
                <h3>Tambah Artikel Kerja Sama Baru</h3>
            </div>
                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo site_url('non_ppkg/kerjasama_non_ppkg/c_kerjasama_non_ppkg/store/'); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">

                                    <br />
                                    <center>
                                        <h1>Formulir Artikel Kerja Sama</h1>
                                    </center>
                                    <br />
                                    <br />
