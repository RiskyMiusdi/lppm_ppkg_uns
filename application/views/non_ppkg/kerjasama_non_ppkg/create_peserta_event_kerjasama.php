					...
					<div class="col-md-12 col-sm-9 col-xs-12">
						...
						<div class="" role="tabpanel" data-example-id="togglable-tabs">
							...
							<div id="myTabContent" class="tab-content">
								...
								<form method="post" action="<?php echo site_url('non_ppkg/kerjasama_non_ppkg/c_kerjasama_non_ppkg/store_peserta/'); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
									<br />
									<center>
									...
									<div class="form-group">
										<div class="col-md-6 col-md-offset-3">
											<a class="btn btn-primary" href="<?php echo site_url('non_ppkg/kerjasama_non_ppkg/c_kerjasama_non_ppkg/daftar_semua_event/'); ?>">Batal</a>
