                ...
                <div class="x_panel" style="background-color:#ebebeb;">
                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        <div class="x_content">
                            ...
                            <br />
                            <a href="<?php echo site_url('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/create_peserta_event_penelitian/' . $event->id_penelitian); ?>" class="btn btn-success">Tambah Peserta</a>
                                    ...
                                    ?>
                                        <tr style="border:2px solid black;">
                                            ...
                                            <td style="border:2px solid black;">
                                                <a class="btn btn-info" href="<?php echo site_url('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/edit_peserta_event_penelitian/' . $row->id_registrasi); ?>">Edit</a>

                                                <a class="btn btn-danger" href="<?php echo site_url('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/delete_peserta/' . $row->id_registrasi); ?>">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
