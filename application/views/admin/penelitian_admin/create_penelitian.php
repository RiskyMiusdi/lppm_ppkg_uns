                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <form method="post" action="<?php echo base_url(); ?>index.php/admin/penelitian_admin/c_penelitian_admin/store_event" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                    <br />
                                    <center>
