            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="background-color:#ebebeb;">
                    ...
                    <div class="x_content">
                        ...
                        <br />
                        <a href="<?php echo base_url(); ?>index.php/admin/seminar_admin/c_seminar_admin/create_artikel" class="btn btn-success">Tambah Artikel</a>
                                ...
                                ?>
                                    <tr style="border:2px solid black;">
                                        ...
                                        <td style="border:2px solid black;">
                                            <a href="<?php echo base_url(); ?>index.php/admin/seminar_admin/c_seminar_admin/edit_artikel/<?php echo $row->id_artikel_seminar; ?>" class="btn btn-warning">Edit</a>
                                            <a class="btn btn-info" href="<?php echo site_url('c_seminar/lihat_artikel_seminar/' . $row->id_artikel_seminar); ?>">Lihat</a>
                                            <a href="<?php echo base_url(); ?>index.php/admin/seminar_admin/c_seminar_admin/delete_artikel/<?php echo $row->id_artikel_seminar; ?>" class="btn btn-danger">Hapus</a>
