                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo site_url('admin/seminar_admin/c_seminar_admin/update_artikel/' . $seminar->id_artikel_seminar); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">

                                    <br />
                                    <center>
                                        <span class="section">Formulir Artikel Seminar</span>
                                    </center>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input required value="<?php echo $seminar->tanggal_publikasi; ?>" id="tanggal_publikasi" class="form-control col-md-7 col-xs-12" name="tanggal_publikasi" type="date">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input required value="<?php echo $seminar->penulis; ?>" id="penulis" class="form-control col-md-7 col-xs-12" name="penulis" type="text">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea required id="judul_artikel" class="form-control col-md-7 col-xs-12" name="judul_artikel" type="text"><?php echo $seminar->judul_artikel; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea required id="paragraf1" class="form-control col-md-7 col-xs-12" name="paragraf1" type="text"><?php echo $seminar->paragraf1; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="status" class="form-control col-md-7 col-xs-12" name="status" required="required">
                                                ...
                                                <option value="<?php echo $seminar->status; ?>"><?php echo $seminar->status; ?></option>
