                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo site_url('admin/pengabdian_admin/c_pengabdian_admin/update_event/' . $pengabdian->id_pengabdian); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">

                                    <br />
                                    <center>
                                        <span class="section">Formulir Event Pengabdian </span>
                                    </center>
                                    <br />
                                    <br />
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/admin/pengabdian_admin/c_pengabdian_admin/daftar_semua_event">Batal</a>
