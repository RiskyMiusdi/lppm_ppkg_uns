                ...
                <div class="x_panel" style="background-color:#ebebeb;">
                    ...
                    <div class="x_content">
                        <center>
                            ...
                            <h1>Daftar Artikel Kerja Sama</h1>
                        </center>
                        <br />
                        <a href="<?php echo base_url(); ?>index.php/admin/kerjasama_admin/c_kerjasama_admin/create_artikel" class="btn btn-success">Tambah Artikel</a>
                                ...
                                ?>
                                    <tr style="border:2px solid black;">
                                        ...
                                        <td style="border:2px solid black;">
                                            <a href="<?php echo base_url(); ?>index.php/admin/kerjasama_admin/c_kerjasama_admin/edit_artikel/<?php echo $row->id_artikel_kerjasama; ?>" class="btn btn-warning">Edit</a>
                                            <a class="btn btn-info" href="<?php echo site_url('c_kerjasama/lihat_artikel_kerjasama/' . $row->id_artikel_kerjasama); ?>">Lihat</a>
                                            <a href="<?php echo base_url(); ?>index.php/admin/kerjasama_admin/c_kerjasama_admin/delete_artikel/<?php echo $row->id_artikel_kerjasama; ?>" class="btn btn-danger">Hapus</a>
