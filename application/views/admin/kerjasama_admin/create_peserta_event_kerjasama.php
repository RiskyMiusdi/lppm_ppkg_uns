					...
					<div class="col-md-12 col-sm-9 col-xs-12">
						...
						<div class="" role="tabpanel" data-example-id="togglable-tabs">
							...
							<div id="myTabContent" class="tab-content">
								...
								<form method="post" action="<?php echo site_url('admin/kerjasama_admin/c_kerjasama_admin/store_peserta/' . $event->id_kerjasama); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
									<br />
									<center>
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input readonly id="id_kerjasama" class="form-control col-md-7 col-xs-12" name="id_kerjasama" required="required" type="hidden" value="<?php echo $event->id_kerjasama; ?>">
										</div>
									</div>
									<div class="item form-group">
									...
									<div class="form-group">
										<div class="col-md-6 col-md-offset-3">
											<a class="btn btn-primary" href="<?php echo site_url('admin/kerjasama_admin/c_kerjasama_admin/daftar_semua_peserta/' . $event->id_kerjasama); ?>">Batal</a>
