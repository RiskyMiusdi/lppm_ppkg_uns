                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <form method="post" action="<?php echo base_url(); ?><?php echo "index.php/admin/c_member/update/" . $user->id_user; ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                    <br />
                                    <center>
                                        <span class="section">Form Edit Data Member</span>
                                    </center>
                                    <br />
                                    <br />
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <center>
                                                ...
                                                <img width="200" src="<?php echo base_url(); ?>uploads/<?php echo $user->avatar; ?>" />
                                            </center>
