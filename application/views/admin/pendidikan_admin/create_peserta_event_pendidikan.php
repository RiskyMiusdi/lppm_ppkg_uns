					...
					<div class="col-md-12 col-sm-9 col-xs-12">
						...
						<div class="" role="tabpanel" data-example-id="togglable-tabs">
							...
							<div id="myTabContent" class="tab-content">
								...
								<form method="post" action="<?php echo site_url('admin/pendidikan_admin/c_pendidikan_admin/store_peserta/' . $event->id_pendidikan); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
									<br />
									<center>
									...
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_peserta">ID Peserta<span class="required"></span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<select id="id_peserta" class="form-control col-md-7 col-xs-12" name="id_peserta" required="required">
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<select id="nama_lengkap" class="form-control col-md-7 col-xs-12" name="nama_lengkap" required="required">
												<?php foreach ($user2 as $row) { ?>
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input readonly id="id_pendidikan" class="form-control col-md-7 col-xs-12" name="id_pendidikan" required="required" type="hidden" value="<?php echo $event->id_pendidikan; ?>">
										</div>
									</div>
									<div class="item form-group">
									...
									<div class="form-group">
										<div class="col-md-6 col-md-offset-3">
											<a class="btn btn-primary" href="<?php echo site_url('admin/pendidikan_admin/c_pendidikan_admin/daftar_semua_peserta/' . $event->id_pendidikan); ?>">Batal</a>
