        ...
        <div style="background-color:#ebebeb;" class="x_panel">
          <div class="col-md-12 col-sm-9 col-xs-12">
            <div class="x_content">
              ...
              <center>
                <h1>Daftar Event Pendidikan</h1>
              </center>
              <a href="<?php echo base_url(); ?>index.php/admin/pendidikan_admin/c_pendidikan_admin/create_event" class="btn btn-success">Tambah Event</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr style="border:2px solid black;">
                      ...
                      <td style="border:2px solid black;"><a class="btn btn-link" href="<?php echo site_url('admin/pendidikan_admin/c_pendidikan_admin/daftar_semua_peserta/' . $row->id_pendidikan) ?>"><?php echo $row->kuota; ?></a></td>
                      <td style="border:2px solid black;">
                        <a class="btn btn-info" href="<?php echo site_url('admin/pendidikan_admin/c_pendidikan_admin/edit_event/' . $row->id_pendidikan); ?>">Kelola</a>
                        <a class="btn btn-warning" href="<?php echo site_url('c_pendidikan/lihat_event_pendidikan/' . $row->id_pendidikan); ?>">Lihat</a>
                        <a class="btn btn-danger" href="<?php echo site_url('admin/pendidikan_admin/c_pendidikan_admin/delete_event/' . $row->id_pendidikan); ?>">Hapus</a>
                      </td>
                    </tr>
                  <?php
                  }
