                ...
                <div class="x_panel" style="background-color:#ebebeb;">
                    ...
                    <div class="x_content">
                        <center>
                            ...
                            <h1>Daftar Artikel Pendidikan</h1>
                        </center>
                        <br />
                        <a href="<?php echo base_url(); ?>index.php/admin/pendidikan_admin/c_pendidikan_admin/create_artikel" class="btn btn-success">Tambah Artikel</a>
                                ...
                                ?>
                                    <tr style="border:2px solid black;">
                                        ...
                                        <td style="border:2px solid black;">
                                            <a href="<?php echo base_url(); ?>index.php/admin/pendidikan_admin/c_pendidikan_admin/edit_artikel/<?php echo $row->id_artikel_pendidikan; ?>" class="btn btn-warning">Edit</a>
                                            <a class="btn btn-info" href="<?php echo site_url('c_pendidikan/lihat_artikel_pendidikan/' . $row->id_artikel_pendidikan); ?>">Lihat</a>
                                            <a href="<?php echo base_url(); ?>index.php/admin/pendidikan_admin/c_pendidikan_admin/delete_artikel/<?php echo $row->id_artikel_pendidikan; ?>" class="btn btn-danger">Hapus</a>
