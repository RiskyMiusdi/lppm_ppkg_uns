                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <form method="post" action="<?php echo base_url(); ?>index.php/ppkg/penelitian_ppkg/c_penelitian_ppkg/store_event_penelitian" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                    <br />
                                    <center>
