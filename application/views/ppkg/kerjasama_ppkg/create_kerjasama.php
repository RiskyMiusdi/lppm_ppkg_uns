    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                ...
                <h3>Tambah Event Kerja Sama Baru</h3>
            </div>
                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <form method="post" action="<?php echo base_url(); ?>index.php/ppkg/kerjasama_ppkg/c_kerjasama_ppkg/store_event_kerjasama" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                    <br />
                                    <center>
                                        <span class="section">Formulir Event Kerja Sama</span>
                                    </center>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/ppkg/kerjasama_ppkg/c_kerjasama_ppkg/daftar_semua_event">Batal</a>
