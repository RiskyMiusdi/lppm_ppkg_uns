                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo site_url('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/update_artikel/' . $pengabdian->id_artikel_pengabdian); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
