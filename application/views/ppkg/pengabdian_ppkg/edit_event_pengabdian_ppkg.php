                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo site_url('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/update_event_pengabdian/' . $pengabdian->id_pengabdian); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/ppkg/pengabdian_ppkg/c_pengabdian_ppkg/daftar_semua_event">Batal</a>
