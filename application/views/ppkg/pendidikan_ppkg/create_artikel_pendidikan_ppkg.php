                    ...
                    <div class="col-md-12 col-sm-9 col-xs-12">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo site_url('ppkg/pendidikan_ppkg/c_pendidikan_ppkg/store_artikel/'); ?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
