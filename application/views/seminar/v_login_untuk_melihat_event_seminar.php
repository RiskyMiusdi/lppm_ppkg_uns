		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="contact-form">
					...
					<form method="post" action="<?php echo site_url('c_login/proses_untuk_melihat_event_seminar/' . $event->id_seminar); ?>">

						<div class="form-group">

							<input type="hidden" class="form-input" name="id_seminar" id="id_seminar" value="<?php echo $event->id_seminar; ?>">
						</div>
						<div class="form-group">
							<h4>Username</h4>
