				...
				<div class="contact-form">
					<center>
						...
						if ($this->session->flashdata('error') != '') {
							...
							echo '</div>';
						} elseif ($this->session->flashdata('registrasi_event') != '') {
							echo '<div class="alert alert-danger" role="alert">';
							echo $this->session->flashdata('registrasi_event');
							echo '</div>';
						} elseif ($this->session->flashdata('success_register') != '') {
					...
					<form method="post" action="<?php echo site_url('c_login/proses/'); ?>">
						<center>
							<h1>Login</h1>
							<br />
						</center>
