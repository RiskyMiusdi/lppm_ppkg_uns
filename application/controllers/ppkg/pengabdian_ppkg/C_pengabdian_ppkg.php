<?php
class C_pengabdian_ppkg extends CI_Controller
{
    ...
    {
        $data1['title'] = "ppkg - Daftar Event pengabdian";
        ...
        $this->load->view('ppkg/pengabdian_ppkg/pengabdian_ppkg', $data);
    ...
    public function create_event()
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/pengabdian_ppkg/create_pengabdian');
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function edit_event($id_pengabdian)
    {
        ...
        // print_r($data);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/pengabdian_ppkg/edit_event_pengabdian_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_event()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            $this->load->view('ppkg/pengabdian_ppkg/edit_pengabdian_ppkg', $error);
        } else {
            ...
            redirect('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/daftar_semua_event');
        }
    }
    ...
    public function create_peserta($id_pengabdian)
    {
        ...
        // print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/pengabdian_ppkg/create_peserta_event_pengabdian', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_peserta()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            redirect(site_url('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/daftar_semua_event/'));
        }
    }
    ...
    public function daftar_semua_peserta($id_pengabdian)
    {
        ...
        // print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/pengabdian_ppkg/data_peserta_event_pengabdian', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function edit_peserta($id_registrasi)
    {
        ...
        //print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/pengabdian_ppkg/edit_data_peserta_event_pengabdian', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function update_peserta($id_pengabdian)
    {
        ...
        redirect(site_url('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/daftar_semua_peserta/' . $this->input->post('id_pengabdian')));
    }
    ...
    public function delete_peserta($id_registrasi)
    {
        ...
        redirect(site_url('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/daftar_semua_peserta/' . $data['x']->id_pengabdian));
    }
    public function daftar_semua_artikel()
    {
        ...
        $this->load->view('ppkg/pengabdian_ppkg/artikel_ppkg', $data1);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function create_artikel()
    {
        ...
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/pengabdian_ppkg/create_artikel_pengabdian_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_artikel()
    {
        ...
        redirect('ppkg/pengabdian_ppkg/c_pengabdian_ppkg/daftar_semua_artikel');
    }
    ...
    public function edit_artikel($id_pengabdian)
    {
        ...
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/pengabdian_ppkg/edit_artikel_pengabdian_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
