<?php
class C_kerjasama_ppkg extends CI_Controller
{
    ...
    {
        $data1['title'] = "PPKG - Daftar Event kerjasama";
        ...
        $this->load->view('ppkg/kerjasama_ppkg/kerjasama_ppkg', $data);
    ...
    public function create_event()
    {
        ...
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/kerjasama_ppkg/create_kerjasama');
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_event()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            $this->load->view('ppkg/kerjasama_ppkg/create_kerjasama_ppkg', $error);
        } else {
            ...
            redirect('ppkg/kerjasama_ppkg/c_kerjasama_ppkg/daftar_semua_event');
        }
    }
    ...
    public function edit_event($id_kerjasama)
    {
        ...
        // print_r($data);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/kerjasama_ppkg/edit_event_kerjasama_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function create_peserta($id_kerjasama)
    {
        ...
        // print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/kerjasama_ppkg/create_peserta_event_kerjasama', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_peserta($id_kerjasama)
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            redirect(site_url('ppkg/kerjasama_ppkg/c_kerjasama_ppkg/daftar_semua_event'));
        }
    }
    ...
    public function daftar_semua_peserta($id_kerjasama)
    {
        ...
        // print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/kerjasama_ppkg/data_peserta_event_kerjasama', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function edit_peserta($id_registrasi)
    {
        ...
        //print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/kerjasama_ppkg/edit_data_peserta_event_kerjasama', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function update_peserta($id_kerjasama)
    {
        ...
        redirect(site_url('ppkg/kerjasama_ppkg/c_kerjasama_ppkg/daftar_semua_peserta/' . $this->input->post('id_kerjasama')));
    }
    ...
    public function delete_peserta($id_registrasi)
    {
        ...
        redirect(site_url('ppkg/kerjasama_ppkg/c_kerjasama_ppkg/daftar_semua_peserta/' . $data['x']->id_kerjasama));
    }
    ...
    public function daftar_semua_artikel()
    {
        ...
        $this->load->view('ppkg/kerjasama_ppkg/artikel_ppkg', $data1);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function create_artikel()
    {
        ...
        // print_r($data12);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/kerjasama_ppkg/create_artikel_kerjasama_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_artikel()
    {
        ...
        redirect('ppkg/kerjasama_ppkg/c_kerjasama_ppkg/daftar_semua_artikel');
    }

    public function edit_artikel($id_kerjasama)
    {
        $data1['title'] = "ppkg - Edit Artikel";
        $data['kerjasama'] = $this->Kerjasama_model->get_artikel($id_kerjasama);
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        // print_r($data);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/kerjasama_ppkg/edit_artikel_kerjasama_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
