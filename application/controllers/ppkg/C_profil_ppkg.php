...
class C_profil_ppkg extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('ppkg/profil_ppkg', $data);
	...
	public function update($id_user)
	{
		...
		if ($this->form_validation->run() == false) {
			...
			redirect(site_url('ppkg/c_profil_ppkg/edit/' . $id_user));
		} else {
