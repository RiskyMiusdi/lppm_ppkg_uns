<?php
class C_penelitian_ppkg extends CI_Controller
{
    ...
    {
        $data1['title'] = "ppkg - Daftar Event penelitian";
        ...
        $this->load->view('ppkg/penelitian_ppkg/penelitian_ppkg', $data);
    ...
    public function create_event()
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/penelitian_ppkg/create_penelitian');
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function edit_event($id_penelitian)
    {
        ...
        // print_r($data);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/penelitian_ppkg/edit_event_penelitian_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_event()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            $this->load->view('ppkg/penelitian_ppkg/edit_penelitian_ppkg', $error);
        } else {
            ...
            redirect('ppkg/penelitian_ppkg/c_penelitian_ppkg/daftar_semua_event');
        }
    }
    ...
    public function create_peserta($id_penelitian)
    {
        ...
        // print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/penelitian_ppkg/create_peserta_event_penelitian', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_peserta()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            redirect(site_url('ppkg/penelitian_ppkg/c_penelitian_ppkg/daftar_semua_event/'));
        }
    }
    ...
    public function daftar_semua_peserta($id_penelitian)
    {
        ...
        $data['join'] = $this->Penelitian_model->join2table()->result();
        $data['event'] = $this->Penelitian_model->get_event($id_penelitian);
        // $data['event']        = $this->Pendaftaran_event_penelitian_model->get_registrasi_event_penelitian($id_penelitian);
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        // print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/penelitian_ppkg/data_peserta_event_penelitian', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function edit_peserta($id_registrasi)
    {
        ...
        //print_r($datax);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/penelitian_ppkg/edit_data_peserta_event_penelitian', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function update_peserta($id_penelitian)
    {
        ...
        redirect(site_url('ppkg/penelitian_ppkg/c_penelitian_ppkg/daftar_semua_peserta/' . $this->input->post('id_penelitian')));
    }
    ...
    public function delete_peserta($id_registrasi)
    {
        ...
        redirect(site_url('ppkg/penelitian_ppkg/c_penelitian_ppkg/daftar_semua_peserta/' . $data['x']->id_penelitian));
    }
    ...
    public function daftar_semua_artikel()
    {
        ...
        $this->load->view('ppkg/penelitian_ppkg/artikel_ppkg', $data1);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function create_artikel()
    {
        ...
        // print_r($data);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/penelitian_ppkg/create_artikel_penelitian_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
    ...
    public function store_artikel()
    {
        ...
        redirect('ppkg/penelitian_ppkg/c_penelitian_ppkg/daftar_semua_artikel');
    }
    ...
    public function edit_artikel($id_penelitian)
    {
        ...
        // print_r($data);
        $this->load->view('ppkg/_partials/header', $data1);
        $this->load->view('ppkg/penelitian_ppkg/edit_artikel_penelitian_ppkg', $data);
        $this->load->view('ppkg/_partials/footer');
    }
