<?php
class C_penelitian_non_ppkg extends CI_Controller
{
    ...
    {
        $data1['title'] = "non_ppkg - Daftar Event penelitian";
        ...
        $this->load->view('non_ppkg/penelitian_non_ppkg/penelitian_non_ppkg', $data);
    ...
    public function create_event()
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/penelitian_non_ppkg/create_penelitian');
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function edit_event($id_penelitian)
    {
        ...
        // print_r($data);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/penelitian_non_ppkg/edit_event_penelitian_non_ppkg', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function store_event()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            $this->load->view('non_ppkg/penelitian_non_ppkg/edit_penelitian_non_ppkg', $error);
        } else {
            ...
            $this->Penelitian_model->create($data);

            redirect('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/daftar_semua_event');
        }
    }
    ...
    public function create_peserta($id_penelitian)
    {
        ...
        // print_r($datax);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/penelitian_non_ppkg/create_peserta_event_penelitian', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function store_peserta()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            redirect(site_url('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/daftar_semua_event/'));
        }
    }
    ...
    public function daftar_semua_peserta($id_penelitian)
    {
        ...
        $data['join'] = $this->Penelitian_model->join2table()->result();
        $data['event'] = $this->Penelitian_model->get_event($id_penelitian);
        // $data['event']        = $this->Penelitian_model->get_registrasi_event($id_penelitian);
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        // print_r($datax);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/penelitian_non_ppkg/data_peserta_event_penelitian', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function edit_peserta($id_registrasi)
    {
        ...
        //print_r($datax);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/penelitian_non_ppkg/edit_data_peserta_event_penelitian', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function update_peserta($id_penelitian)
    {
        ...
        redirect(site_url('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/daftar_semua_peserta/' . $this->input->post('id_penelitian')));
    }
    ...
    public function delete_peserta($id_registrasi)
    {
        ...
        redirect(site_url('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/daftar_semua_peserta/' . $data['x']->id_penelitian));
    }
    ...
    public function daftar_semua_artikel()
    {
        ...
        $this->load->view('non_ppkg/penelitian_non_ppkg/artikel_non_ppkg', $data1);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function create_artikel()
    {
        ...
        // print_r($data);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/penelitian_non_ppkg/create_artikel_penelitian_non_ppkg', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function store_artikel()
    {
        ...
        redirect('non_ppkg/penelitian_non_ppkg/c_penelitian_non_ppkg/daftar_semua_artikel');
    }
    ...
    public function edit_artikel($id_penelitian)
    {
        ...
        // print_r($data);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/penelitian_non_ppkg/edit_artikel_penelitian_non_ppkg', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
