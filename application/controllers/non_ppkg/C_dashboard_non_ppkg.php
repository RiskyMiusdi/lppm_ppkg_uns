...
class C_dashboard_non_ppkg extends CI_Controller
{
	...
	{
		$data1['title'] = 'non_ppkg - Dashboard';

		$table_name = 'user'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung

		$table_event_pendidikan = 'tbl_event_pendidikan'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung
		$table_artikel_pendidikan = 'tbl_artikel_pendidikan'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung

		$table_event_pengabdian = 'tbl_event_pengabdian'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung
		$table_artikel_pengabdian = 'tbl_artikel_pengabdian'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung

		$table_event_penelitian = 'tbl_event_penelitian'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung
		$table_artikel_penelitian = 'tbl_artikel_penelitian'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung

		$table_event_seminar = 'tbl_event_seminar'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung
		$table_artikel_seminar = 'tbl_artikel_seminar'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung

		$table_event_kerjasama = 'tbl_event_kerjasama'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung
		$table_artikel_kerjasama = 'tbl_artikel_kerjasama'; // Ganti 'nama_tabel' dengan nama tabel yang ingin Anda hitung

		$data['total_user'] = $this->User_model->count_rows($table_name);
		$data['total_user_ppkg'] = $this->User_model->count_non_ppkg_rows();
		...
		$this->load->view('non_ppkg/dashboard_non_ppkg', $data);
