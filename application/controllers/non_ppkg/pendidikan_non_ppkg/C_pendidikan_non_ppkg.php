<?php
class C_pendidikan_non_ppkg extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        // $this->load->model('Pendaftaran_event_pendidikan_model');
    ...
    {
        $data1['title'] = "non_ppkg - Daftar Event Pendidikan";
        ...
        $this->load->view('non_ppkg/pendidikan_non_ppkg/pendidikan_non_ppkg', $data);
    ...
    public function create_event()
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/pendidikan_non_ppkg/create_pendidikan');
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function edit_event($id_pendidikan)
    {
        ...
        // print_r($data);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/pendidikan_non_ppkg/edit_event_pendidikan_non_ppkg', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function store_event()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            $this->load->view('non_ppkg/pendidikan_non_ppkg/edit_pendidikan_non_ppkg', $error);
        } else {
            ...
            redirect('non_ppkg/pendidikan_non_ppkg/c_pendidikan_non_ppkg/daftar_semua_event');
        }
    }
    ...
    public function create_peserta($id_pendidikan)
    {
        ...
        $data['join'] = $this->Pendidikan_model->join2table()->result();
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/pendidikan_non_ppkg/create_peserta_event_pendidikan', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function store_peserta()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            redirect(site_url('non_ppkg/pendidikan_non_ppkg/c_pendidikan_non_ppkg/daftar_semua_event/'));
        }
    }
    ...
    public function daftar_semua_peserta($id_pendidikan)
    {
        ...
        $data['join'] = $this->Pendidikan_model->join2table()->result();
        $data['event'] = $this->Pendidikan_model->get_event($id_pendidikan);
        // $data['event']        = $this->Pendaftaran_event_pendidikan_model->get_registrasi_event_pendidikan($id_pendidikan);
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        // print_r($datax);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/pendidikan_non_ppkg/data_peserta_event_pendidikan', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function edit_peserta($id_registrasi)
    {
        ...
        //print_r($datax);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/pendidikan_non_ppkg/edit_data_peserta_event_pendidikan', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function update_peserta($id_pendidikan)
    {
        ...
        redirect(site_url('non_ppkg/pendidikan_non_ppkg/c_pendidikan_non_ppkg/daftar_semua_peserta/' . $this->input->post('id_pendidikan')));
    }
    ...
    public function delete_peserta($id_registrasi)
    {
        ...
        redirect(site_url('non_ppkg/pendidikan_non_ppkg/c_pendidikan_non_ppkg/daftar_semua_peserta/' . $data['x']->id_pendidikan));
    }
    public function daftar_semua_artikel()
    {
        ...
        $this->load->view('non_ppkg/pendidikan_non_ppkg/artikel_non_ppkg', $data1);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function create_artikel()
    {
        ...
        // print_r($data);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/pendidikan_non_ppkg/create_artikel_pendidikan_non_ppkg', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
    ...
    public function store_artikel()
    {
        ...
        redirect('non_ppkg/pendidikan_non_ppkg/c_pendidikan_non_ppkg/daftar_semua_artikel');
    }
    ...
    public function edit_artikel($id_pendidikan)
    {
        ...
        // print_r($data);
        $this->load->view('non_ppkg/_partials/header', $data1);
        $this->load->view('non_ppkg/pendidikan_non_ppkg/edit_artikel_pendidikan_non_ppkg', $data);
        $this->load->view('non_ppkg/_partials/footer');
    }
