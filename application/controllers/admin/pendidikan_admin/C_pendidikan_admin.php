<?php
class C_pendidikan_admin extends CI_Controller
{
    ...
    {
        $data1['title'] = "Admin - Daftar Event Pendidikan";
        ...
        $this->load->view('admin/pendidikan_admin/pendidikan_admin', $data);
    ...
    public function create_event()
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/pendidikan_admin/create_pendidikan');
        $this->load->view('admin/_partials/footer');
    }
    public function store_event()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            $this->load->view('admin/pendidikan_admin/edit_pendidikan_admin', $error);
        } else {
            ...
            redirect('admin/pendidikan_admin/c_pendidikan_admin/daftar_semua_event');
        }
    }
    ...
    public function edit_event($id_pendidikan)
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/pendidikan_admin/edit_event_pendidikan_admin', $data);
        $this->load->view('admin/_partials/footer');
    }
    public function update_event($id_pendidikan)
    {
        ...
        if (!empty($_FILES['avatar']['name'])) {
            ...
            if (!$this->upload->do_upload('avatar')) {
                ...
                redirect('admin/pendidikan_admin/c_pendidikan_admin/edit_event');
            }
    ...
    public function create_peserta($id_pendidikan)
    {
        ...
        $data['join'] = $this->Pendidikan_model->join2table()->result();
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/pendidikan_admin/create_peserta_event_pendidikan', $data);
        $this->load->view('admin/_partials/footer');
    }
    public function store_peserta($id_pendidikan)
    {
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'gif|jpg|jpeg|png';
        $config['max_size'] = 5000;
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            redirect(site_url('admin/pendidikan_admin/c_pendidikan_admin/daftar_semua_peserta/' . $id_pendidikan));
        }
    }
    ...
    public function daftar_semua_peserta($id_pendidikan)
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/pendidikan_admin/data_peserta_event_pendidikan', $data);
        $this->load->view('admin/_partials/footer');
    }
    public function edit_peserta($id_registrasi)
    {
        ...
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/pendidikan_admin/edit_data_peserta_event_pendidikan', $data);
        $this->load->view('admin/_partials/footer');
    }
    public function update_peserta($id_pendidikan)
    {
        ...
        redirect(site_url('admin/pendidikan_admin/c_pendidikan_admin/daftar_semua_peserta/' . $this->input->post('id_pendidikan')));
    }
    ...
    public function delete_peserta($id_registrasi)
    {
        ...
        redirect(site_url('admin/pendidikan_admin/c_pendidikan_admin/daftar_semua_peserta/' . $data['x']->id_pendidikan));
    }
    ...
    public function daftar_semua_artikel()
    {
        ...
        $this->load->view('admin/pendidikan_admin/artikel_admin', $data1);
        $this->load->view('admin/_partials/footer');
    }
    ...
    public function create_artikel()
    {
        ...
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/pendidikan_admin/create_artikel_pendidikan_admin', $data);
        $this->load->view('admin/_partials/footer');
    }
    public function store_artikel()
    {
        ...
        redirect('admin/pendidikan_admin/c_pendidikan_admin/daftar_semua_artikel');
    }
    ...
    public function edit_artikel($id_pendidikan)
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/pendidikan_admin/edit_artikel_pendidikan_admin', $data);
        $this->load->view('admin/_partials/footer');
    }
