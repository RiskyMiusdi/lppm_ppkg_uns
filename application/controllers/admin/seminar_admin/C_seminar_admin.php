<?php
class C_seminar_admin extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        // $this->load->model('Pendaftaran_event_seminar_model');
    ...
    {
        $data1['title'] = "Admin - Daftar Event seminar";
        ...
        $this->load->view('admin/seminar_admin/seminar_admin', $data);
    ...
    public function create_event()
    {
        ...
        $data1['user'] = $this->db->get_where('user', ['username' => $this->session->userdata('username')])->row_array();
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/seminar_admin/create_seminar');
        $this->load->view('admin/_partials/footer');
    }
    ...
    public function store_event()
    {
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            $this->load->view('admin/seminar_admin/edit_seminar_admin', $error);
        } else {
            ...
            redirect('admin/seminar_admin/c_seminar_admin/daftar_semua_event');
        }
    }
    ...
    public function edit_event($id_seminar)
    {
        ...
        // print_r($data);
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/seminar_admin/edit_event_seminar_admin', $data);
        $this->load->view('admin/_partials/footer');
    }
    ...
    public function create_peserta($id_seminar)
    {
        ...
        // print_r($datax);
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/seminar_admin/create_peserta_event_seminar', $data);
        $this->load->view('admin/_partials/footer');
    }

    public function store_peserta($id_seminar)
    {
        $config['upload_path'] = './uploads/';
        $config['allowed_types'] = 'gif|jpg|jpeg|png';
        $config['max_size'] = 5000;
        ...
        if (!$this->upload->do_upload('avatar')) {
            ...
            redirect(site_url('admin/seminar_admin/c_seminar_admin/daftar_semua_peserta/' . $id_seminar));
        }
    }
    ...
    public function daftar_semua_peserta($id_seminar)
    {
        ...
        // print_r($datax);
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/seminar_admin/data_peserta_event_seminar', $data);
        $this->load->view('admin/_partials/footer');
    }
    ...
    public function edit_peserta($id_registrasi)
    {
        ...
        //print_r($datax);
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/seminar_admin/edit_data_peserta_event_seminar', $data);
        $this->load->view('admin/_partials/footer');
    }
    ...
    public function update_peserta($id_seminar)
    {
        ...
        redirect(site_url('admin/seminar_admin/c_seminar_admin/daftar_semua_peserta/' . $this->input->post('id_seminar')));
    }
    ...
    public function delete_peserta($id_registrasi)
    {
        ...
        redirect(site_url('admin/seminar_admin/c_seminar_admin/daftar_semua_peserta/' . $data['x']->id_seminar));
    }
    ...
    public function daftar_semua_artikel()
    {
        ...
        $this->load->view('admin/seminar_admin/artikel_admin', $data1);
        $this->load->view('admin/_partials/footer');
    }
    ...
    public function create_artikel()
    {
        ...
        // print_r($data);
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/seminar_admin/create_artikel_seminar_admin', $data);
        $this->load->view('admin/_partials/footer');
    }
    ...
    public function store_artikel()
    {
        ...
        redirect('admin/seminar_admin/c_seminar_admin/daftar_semua_artikel');
    }
    ...
    public function edit_artikel($id_seminar)
    {
        ...
        // print_r($data);
        $this->load->view('admin/_partials/header', $data1);
        $this->load->view('admin/seminar_admin/edit_artikel_seminar_admin', $data);
        $this->load->view('admin/_partials/footer');
    }
