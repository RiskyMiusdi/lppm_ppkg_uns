...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2023 at 01:41 AM
...
(1, '', '2021-08-16', 'SARASEHAN_BULANAN.jpg', 'Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event.<br /><br /><br />\r\n<br /><br /><br />\r\nDeskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. ', 'Zoom', 'PPKG', 100, '2021-08-02', 1),
(2, 'Mini Talk Show VOCATION 2.0', '2020-12-02', 'mini_talk.jpg', 'Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. <br />\r\n<br />\r\nDeskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. ', 'Zoom', 'PPKG', 35, '2020-11-30', 1),
(3, 'Dr. SUMARDIYONO, S.KM, M.Kes MELAKUKAN DESIMINASI HASIL PENGABDIAN KEPADA MASYARAKAT TIM PENGABDI PPKG LPPM UNS PADA SEMINAR NASONAL DAN CALL FOR PAPER PKM CENTER UNIVERSITAS SEBELAS MARET SURAKARTA', '2022-12-22', 'Dr__Sumardiyono.jpg', 'Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. <br /><br />\r\n<br /><br />\r\nDeskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. Deskripsi event. ', 'Zoom', 'PPKG', 100, '2022-12-05', 1);
